                      ...
                      Card(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text( translate("discounted_orders_history.total_orders"),
                                style: TextStyle(
                                    fontSize: 25,
                                    color: yellowColor,
                                    fontWeight: FontWeight.bold
                                                ...
                                                Padding(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      Row(
                                                        children: [
                                                          Text(translate("discounted_orders_history.total"),
                                                            style: TextStyle(
                                                                fontSize: 16,
                                                                fontWeight: FontWeight.bold,
                                                                color: yellowColor
                                                      ...
                                                      Visibility(
                                                        ...
                                                        child: Row(
                                                          children: [
                                                            Text(translate("discounted_orders_history.table"),
                                                              style: TextStyle(
                                                                  fontSize: 16,
                                                                  fontWeight: FontWeight.bold,
                                                                  color: yellowColor
                                ...
                                children: [
                                  Expanded(
                                    ...
                                    child: Container(
                                      ...
                                      child: Center(
                                        child: AutoSizeText(
                                          translate("discounted_orders_history_popup.items"),
                                          style: TextStyle(
