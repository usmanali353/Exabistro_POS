...
class RefundedOrdersScreenForMobile extends StatefulWidget {
  var store;

  RefundedOrdersScreenForMobile(this.store);

  @override
  _KitchenTabViewState createState() => _KitchenTabViewState();
}

class _KitchenTabViewState extends State<RefundedOrdersScreenForMobile> with TickerProviderStateMixin {
                      ...
                      Card(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text( translate("refunded_orders_history.total_orders"),
                                style: TextStyle(
                                    fontSize: 25,
                                    color: yellowColor,
                                    fontWeight: FontWeight.bold
                                                ...
                                                Padding(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      Row(
                                                        children: [
                                                          Text(translate("refunded_orders_history.total"),
                                                            style: TextStyle(
                                                                fontSize: 20,
                                                                fontWeight: FontWeight.bold,
                                                                color: yellowColor
                                                      ...
                                                      Visibility(
                                                        ...
                                                        child: Row(
                                                          children: [
                                                            Text(translate("refunded_orders_history.table"),
                                                              style: TextStyle(
                                                                  fontSize: 20,
                                                                  fontWeight: FontWeight.bold,
                                                                  color: yellowColor
                                ...
                                children: [
                                  Expanded(
                                    ...
                                    child: Container(
                                      ...
                                      child: Center(
                                        child: AutoSizeText(
                                          translate("refunded_orders_history_popup.items"),
                                          style: TextStyle(
