...
class POSCartScreenForMobile extends StatefulWidget {
  var store;
  POSCartScreenForMobile({this.store});
  @override
  _POSCartScreenForMobileState createState() => _POSCartScreenForMobileState();
}

class _POSCartScreenForMobileState extends State<POSCartScreenForMobile> {
