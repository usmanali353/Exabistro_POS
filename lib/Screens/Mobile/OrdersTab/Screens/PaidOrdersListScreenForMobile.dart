...
class PaidOrdersScreenForMobile extends StatefulWidget {
  var store;

  PaidOrdersScreenForMobile(this.store);

  @override
  _KitchenTabViewState createState() => _KitchenTabViewState();
}

class _KitchenTabViewState extends State<PaidOrdersScreenForMobile>{
                              ...
                              Card(
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(translate("paid_today_orders.total_orders"),
                                        style: TextStyle(
                                            fontSize: 25,
                                            color: yellowColor,
                                            fontWeight: FontWeight.bold
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Visibility(
                                                      ...
                                                      child: Row(
                                                        children: [
                                                          Text(translate("paid_today_orders.table"),
                                                            style: TextStyle(
                                                                fontSize: 20,
                                                                fontWeight: FontWeight.bold,
                                                                color: yellowColor
  ...
  Widget orderDetailPopup(dynamic orders){
    debugPrint(orders["isRefunded"].toString());
                                            ...
                                            child: Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  orders["isRefunded"]!=null||orders["isRefunded"]==true?FaIcon(FontAwesomeIcons.handHoldingUsd, color: blueColor,):Container(),
                                                ],
                                              ),
                                            )
                                        ),
            ...
            child: Column(
              children: [
                Container(
                  ...
                  height: 40,
                  color: yellowColor,
                  child: Center(child: Text(translate("paid_today_orders_popup.refund_items"),style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold,color: BackgroundColor),)),
