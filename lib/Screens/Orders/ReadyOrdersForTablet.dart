        ...
        body: RefreshIndicator(
          ...
          onRefresh: (){
            return Utils.check_connectivity().then((result){
              if(result){
                Network_Operations.getAllOrdersWithItemsByOrderStatusId(context, token, 5,widget.storeId).then((value) {
                  setState(() {
                    orderList = value;
          ...
          setState(() {
            ...
            if(_selected[i]){
              Utils.check_connectivity().then((result){
                if(result){
                  orderList.clear();
                  Network_Operations.getAllOrdersWithItemsByOrderStatusIdCategorized(context, token, 5,categoryList[i].id,widget.storeId).then((value) {
                    setState(() {
                      orderList = value;
                    });
                  });
